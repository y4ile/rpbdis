...
public partial class PlansDBContext : DbContext
{
    public PlansDBContext()
    {

    }

    public PlansDBContext(DbContextOptions<PlansDBContext> options)
        : base(options)
    {
    ...
    public virtual DbSet<PlanStagesWithInfo> PlanStagesWithInfos { get; set; }

    public virtual DbSet<Status> Statuses { get; set; }

    public virtual DbSet<StudyPlan> StudyPlans { get; set; }

    public virtual DbSet<StudyPlanWithUserInfo> StudyPlanWithUserInfos { get; set; }

    public virtual DbSet<User> Users { get; set; }

    public virtual DbSet<UsersWithStudyPlan> UsersWithStudyPlans { get; set; }
